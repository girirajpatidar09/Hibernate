...
public class OwnerServiceImpl implements OwnerService {
	...
	@Override
	public OwnerDTO findOwner(String emailId) throws OwnerNotFoundException {
		Owner owner = ownerRepository.findOwner(emailId);
		if (Objects.isNull(owner)) {
			throw new OwnerNotFoundException("OWNER_EMAIL_ID_NOT_FOUND"+ emailId);
		}
		return MapperUtil.convertOwnerEntityToDto(owner);
	}
