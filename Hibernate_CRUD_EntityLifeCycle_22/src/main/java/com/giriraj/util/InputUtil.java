...
public class InputUtil {
	...
	public static int acceptMenuOption(Scanner scanner) {
		System.out.println("Press 1 to demonstrate TRANSIENT state.");
		System.out.println("Press 2 to fetch owner details.");
		System.out.println("Press 3 to demonstrate PERSISTENT state.");
		System.out.println("Press 4 to demonstrate DETACHED state.");
		System.out.println("Press 5 to demonstrate DELETED state.");
