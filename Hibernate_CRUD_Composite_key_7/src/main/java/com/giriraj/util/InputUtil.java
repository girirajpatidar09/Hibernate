...
public class InputUtil {
	...
	public static OwnerPetPrimaryKey acceptCustomPrimaryKeyToOperate(Scanner scanner) {
		System.out.println("Enter id of owner:");
		int ownerId = scanner.nextInt();
		System.out.println("Enter id of pet:");
		int petId = scanner.nextInt();
		OwnerPetPrimaryKey ownerPetPrimaryKey = new OwnerPetPrimaryKey();
		ownerPetPrimaryKey.setId(ownerId);
		ownerPetPrimaryKey.setPetId(petId);
		return ownerPetPrimaryKey;
	}
